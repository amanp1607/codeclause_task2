...
Label_result= Label(root,width=30, height=2, text="", font=("arial", 30))
Label_result.pack()
...
Button(root,text="=", width=11, height=1, font=("arial",30, "bold"), bd=1,fg="#fff",bg="#EF7429", command= lambda:calculate()).place(x=290,y=500)
